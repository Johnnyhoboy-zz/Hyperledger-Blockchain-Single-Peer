...
describe('OrderPlacedComponent', () => {
  ...
  let mockOrderPlacedService;
  let mockDataService

  beforeEach(async(() => {

    mockOrderPlacedService = sinon.createStubInstance(OrderPlacedService);
    mockOrderPlacedService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: OrderPlacedService, useValue: mockOrderPlacedService },
