...
describe('OrderShippedComponent', () => {
  ...
  let mockOrderShippedService;
  let mockDataService

  beforeEach(async(() => {

    mockOrderShippedService = sinon.createStubInstance(OrderShippedService);
    mockOrderShippedService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: OrderShippedService, useValue: mockOrderShippedService },
