...
describe('OrderDeliveredComponent', () => {
  ...
  let mockOrderDeliveredService;
  let mockDataService

  beforeEach(async(() => {

    mockOrderDeliveredService = sinon.createStubInstance(OrderDeliveredService);
    mockOrderDeliveredService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: OrderDeliveredService, useValue: mockOrderDeliveredService },
